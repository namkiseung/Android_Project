...
public class Daily_Adapter_List extends BaseAdapter {
    ...
    private ArrayList<Daily_MainItem> mData;
   /* Comparator<Daily_MainItem> nameAsc = new Comparator<Daily_MainItem>() {
    ...
    public Daily_Adapter_List(Context context, ArrayList<Daily_MainItem> data) {                                                    //Context를 받아야한다 그래야 리소스 접근가능 이게 없으면 그냥 단순 클래스가 된다
        mContext = context;
        mData = data;
    }
