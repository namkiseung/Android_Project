package com.namkit.namki.teamnova.Menu1_MainActivity;
...
import com.namkit.namki.teamnova.Menu4_Bookmark.BrowseActivity;
import com.namkit.namki.teamnova.Menu2_Wakeup.Wakeup;
import com.namkit.namki.teamnova.Menu3_Daily.Daily;
import com.namkit.namki.teamnova.Menu5_Monitoring.MainSecond;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, Toolbar.OnMenuItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //로그인에 정보 입력후 버튼 누르면 저장된 정보를 불러와 currentid에 저장
       ...
       /* SharedPreferences prefs = getSharedPreferences("NowUser", 0);
        ...
        ImageButton monitorbutton = (ImageButton) findViewById(R.id.btn_monitor_activity);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_news_activity:
                 Intent moveonnews = new Intent(MainActivity.this, BrowseActivity.class);
                  startActivity(moveonnews);
                break;
            case R.id.btn_monitor_activity:
                Intent monitor = new Intent(MainActivity.this, MainSecond.class);
    ...
    public void onBackPressed() {
        ...
        alert.setPositiveButton("확인", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                logout.putExtra("logoutId", currentid); // Edit입력받은 값 인텐트에 저장(카테고리)
                setResult(RESULT_OK, logout);  //Daily클래스 Intent로 결과값 전달
                finish();  // 해당 액티비티 종료
            }
        });
    ...
    private void exitOptionsDialog() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("회원님의 정보를 확인하세요.")
                .setMessage("ID : "+preferences.getString("currentdisplayId",""))
                ...
                .setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            public void onClick(
                                ...
                                SharedPreferences.Editor editor = preferences.edit();
                                currentid = preferences.getString("currentdisplayId","");
                                System.out.println("(계정삭제)currentid : "+currentid+"    22222222222222222222222");
                                System.out.println("(계정삭제)아이디 : "+preferences.getString(currentid+"TEAM_MEMBER_ID", "")+"    22222222222222222222222");
                                System.out.println("(계정삭제)비밀번호 : "+preferences.getString(currentid+"TEAM_MEMBER_PW", "")+"    22222222222222222222222");
                                System.out.println("(계정삭제)이름 : "+preferences.getString(currentid+"TEAM_MEMBER_NAME", "")+"    22222222222222222222222");
                                System.out.println("(계정삭제)이름으로 아디: "+preferences.getString(currentid+"NAMETOID", "")+"    22222222222222222222222");
                                System.out.println("(계정삭제)나이 : "+preferences.getString(currentid+"TEAM_MEMBER_AGE", "")+"    22222222222222222222222");
                                System.out.println("(계정삭제)이메일 : "+preferences.getString(currentid+"TEAM_MEMBER_EMAIL", "")+"    22222222222222222222222");
                                editor.remove("currentdisplayId");
